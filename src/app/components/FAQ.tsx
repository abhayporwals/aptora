...
export default function FAQ() {
  ...
  return (
    <section className="py-16 md:py-32 relative overflow-hidden" style={{ fontFamily: "Cinzel", fontWeight: 600, fontStyle: "normal", fontOpticalSizing: "auto" }}>
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-foreground/70 max-w-2xl mx-auto" style={{ fontFamily: "Crimson Pro", fontWeight: 400, fontStyle: "normal", fontOpticalSizing: "auto" }}>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="grid gap-4 sm:gap-6">
            {faqs.map((faq, index) => (
              ...
              >
                <div
                  className="relative p-4 sm:p-6 rounded-2xl backdrop-blur-sm bg-card/30 border border-white/5 shadow-xl transition-all duration-300 hover:bg-card/40 cursor-pointer overflow-hidden"
                  onClick={() =>
                ...
                >
                  ...
                  <div className="relative" style={{ fontFamily: "Crimson Pro", fontWeight: 200, fontStyle: "normal", fontOpticalSizing: "auto" }}>
                    <div className="flex justify-between items-center gap-4">
                      <h3 className="text-lg sm:text-xl bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent group-hover:from-primary-light group-hover:to-primary transition-all duration-300 font-semibold tracking-wider">
                        {faq.question}
                      </h3>
                      <div
                        className={`w-6 h-6 sm:w-8 sm:h-8 rounded-xl flex items-center justify-center bg-gradient-to-br from-primary/10 to-primary-light/10 text-primary transition-all duration-300 ${
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-primary to-primary-light hover:from-primary-dark hover:to-primary text-white rounded-full transition-all shadow-lg hover:shadow-primary/25"
            >
              Contact Support
