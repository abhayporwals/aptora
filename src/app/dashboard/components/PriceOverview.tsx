    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-4 rounded-xl bg-card/20 border border-white/5">
          ...
          <div className="text-2xl font-semibold text-primary">${aptPrice.aptos.usd}</div>
        </div>

        <div className="p-4 rounded-xl bg-card/20 border border-white/5">
          <div className="text-sm text-foreground/60 mb-2">USD 24h Volume</div>
          <div className="text-2xl font-semibold text-primary">${(aptPrice.aptos.usd_24h_vol.toFixed(2)).toLocaleString()}</div>
        </div>

        <div className="p-4 rounded-xl bg-card/20 border border-white/5">
          <div className="text-sm text-foreground/60 mb-2">Market Cap</div>
          <div className="text-2xl font-semibold text-primary">${(aptPrice.aptos.usd_market_cap.toFixed(2)).toLocaleString()}</div>
        </div>
      </div>
